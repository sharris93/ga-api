...
// Routes
router.get('/birds', (req, res) => res.json([
  { 
    species: 'Blue Tit',
    subspecies: 'tit',
  ...
  },
  {
    ...
    color: 'Mottled brown, iridescent blue',
    size: 'Medium',
  ...
  },
  {
    ...
    color: 'Colorful plumage with iridescent hues',
    size: 'Medium',
  ...
  },
  {
    ...
    size: 'Medium',
    diet: 'Birds (often caught in flight)'
  },
  {
    species: 'Gyrfalcon',
    subspecies: 'falcon',
